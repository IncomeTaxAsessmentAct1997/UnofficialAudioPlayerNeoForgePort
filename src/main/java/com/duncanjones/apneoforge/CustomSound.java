...
public class CustomSound {
    ...
    public static CustomSound of(ItemStack item) {
        ...
        if (customData == null) {
            AudioPlayer.LOGGER.info("[CustomSound] of(ItemStack): item={} has no CUSTOM_DATA component at all", item);
            return null;
        }
        CustomSound result = of(customData.copyTag());
        AudioPlayer.LOGGER.info("[CustomSound] of(ItemStack): item={} tag={} -> result={}", item, customData.copyTag(), result);
        return result;
    }
    ...
    public static CustomSound of(CompoundTag tag) {
        ...
        if (tag.contains(CUSTOM_SOUND)) {
            ...
            AudioPlayer.LOGGER.info("[CustomSound] of(CompoundTag): tag={} does not contain '{}' key", tag, CUSTOM_SOUND);
            return null;
        }
